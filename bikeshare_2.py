...
# This function will permit user to filter data by city, month, and day
def get_filters():
    """
    ...
    # TO DO: get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs
     while True:
           #avoid to typo by means of entering number rather the city's name
       city_list = ["chicago", "new york city", "washington"]
       city_index = input('Please enter 0 for chicago, 1 for new york city and 2 for washington:')
...
# This function will load data based on the city selected by the user
